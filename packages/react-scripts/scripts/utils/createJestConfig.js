...
module.exports = (resolve, rootDir, isEjecting) => {
  ...
  const config = {
    collectCoverageFrom: [
      'src/**/*.{js,jsx,mjs}',
      'pmt-react-sdk/packages/utils/src/**/*.{js,jsx,mjs}', // @PMT
      'pmt-react-sdk/packages/ui/src/**/*.{js,jsx,mjs}',  // @PMT
      'pmt-react-sdk/packages/modules/src/**/*.{js,jsx,mjs}',  // @PMT
    ],
    ...
    moduleNameMapper: {
      ...
      '^pmt-utils/(.*)$': '<rootDir>/pmt-react-sdk/packages/utils/src/$1', // @PMT
      '^pmt-modules/(.*)$': '<rootDir>/pmt-react-sdk/packages/modules/src/$1', // @PMT
      '^pmt-ui/(.*)$': '<rootDir>/pmt-react-sdk/packages/ui/src/$1', // @PMT
